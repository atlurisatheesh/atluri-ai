        ...
        <div className="space-y-3">
          <GlassCard className="p-5">
            ...
            <div className="text-center py-8">
              <Receipt className="w-8 h-8 text-textMuted mx-auto mb-3" />
              <p className="text-textMuted text-sm">No invoices yet.</p>
              <p className="text-textMuted text-xs mt-1">Invoices will appear here after your first purchase or subscription.</p>
            </div>
          </GlassCard>
        </div>
      ),
